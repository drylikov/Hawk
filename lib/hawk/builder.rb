...
module Hawk
  module Builder
    ...
    def escaped_icon_url
      (icon_path)? CGI.escapeHTML(icon_url) : 'https://raw.githubusercontent.com/drylikov/hawk/master/templates/icon.png'
    end
    ...
    def escaped_fullsize_image_url
      (fullsize_image_path)? CGI.escapeHTML(fullsize_image_url) : 'https://raw.githubusercontent.com/drylikov/hawk/master/templates/fullsize_image.png'
    end
